...
export const metadata: Metadata = {
  title: "Formation IATA DGR au Sénégal — Méthode CBTA",
  description:
    "Formation DGR pour les professionnels du Sénégal, méthode CBTA. Sessions à Dakar ou intra-entreprise, en lien avec la réglementation ANAC Sénégal & OACI.",
  ...
  openGraph: {
    ...
    description:
      "Formation DGR, méthode CBTA, pour les professionnels du transport aérien au Sénégal.",
  ...
  return (
    <CountryLandingPage
      data={{
        ...
        testimonialText:
          "Nous avons pu former toute notre équipe sans envoyer nos agents en Europe. Formation complète, évaluation CBTA, certificat DGR.",
