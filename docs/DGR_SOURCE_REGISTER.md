...
### Q-7.1-001
Need direct current Tier A evidence matching the exact pilot concept. Do not assume old training-course wording for danger/risk.

### Q-7.1-006
Need current Tier A packing-group definitions, including I/II/III and the exact terminology used by the 67e.

### Q-7.1-007
Need current direct Tier A text for A1 and A2 and any provision they point to. Preserve the exact current terminology for approval/authorization/derogation. Do not call A2 a derogation without literal support.
