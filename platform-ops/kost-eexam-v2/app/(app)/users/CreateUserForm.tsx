...
export function CreateUserForm() {
  ...
  return (
    <form action={formAction} className="grid gap-3 sm:grid-cols-5 items-end">
      ...
      <div>
        <label htmlFor="password" className="mb-1 block text-[12px] font-medium text-text-secondary">Mot de passe</label>
        <input id="password" name="password" required minLength={8} className="w-full rounded-md border border-border-default bg-surface-base px-3 py-1.5 text-[13px]" />
      </div>
      <div>
