...
**Rafraîchi le 2026-08-30** (mission "COMPLETE MISSING FILTERS + NORMALIZE QUESTION COUNTS") : les captures 07/08/09 (`/question-bank`) et 28 (`/audit-logs`) ont été reprises après une refonte de ces deux pages (compteurs réglementaire/DEMO explicites, nouveaux panneaux de filtres). Les captures 26/27/29 ont été rafraîchies en même temps (même phase de test), sans changement de contenu attendu. Les 26 autres captures n'ont pas été retouchées — les pages concernées n'ont pas changé. Chaque capture rafraîchie a été re-revue manuellement (mêmes critères que ci-dessus) avant remplacement.
...
| 07 | `07-question-bank.png` | `/question-bank` | admin | Banque de questions — compteurs réglementaire/DEMO, filtres, statut source | ✅ | Rafraîchi 2026-08-30 (mission "COMPLETE MISSING FILTERS + NORMALIZE QUESTION COUNTS") : compteurs explicites 244 réglementaires confirmées / 8 DEMO-brouillon / 252 au total (jamais un total unique), panneau de filtres complet. Bandeau explicite : une question non « Confirmé — source DGR vérifiée » n'entre jamais automatiquement dans un examen de production. |
